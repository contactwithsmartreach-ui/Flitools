    ...
    <div className="min-h-screen bg-[#080314] text-white flex flex-col justify-between font-sans">
      ...
      <main className="flex-1 max-w-4xl w-full mx-auto px-4 md:px-8 pt-32 pb-16">
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h1 className="text-3xl font-light tracking-tight text-white">Client-Side Disclaimer</h1>
            <p className="text-xs text-purple-300/60 mt-0.5">Important disclosure regarding tool processing</p>
          </div>
        </div>

        {/* Feature Highlights Grid */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-8">
          <div className="p-4 rounded-2xl border border-purple-300/20 bg-purple-950/40 backdrop-blur-md">
            <Cpu className="w-5 h-5 text-purple-200 mb-2" />
            <h3 className="text-xs font-semibold text-white mb-1">In-Browser Computing</h3>
          ...
          <div className="p-4 rounded-2xl border border-purple-300/20 bg-purple-950/40 backdrop-blur-md">
            <HardDrive className="w-5 h-5 text-purple-200 mb-2" />
            <h3 className="text-xs font-semibold text-white mb-1">Zero Server Uploads</h3>
            <p className="text-[11px] text-purple-200/70 leading-relaxed">
          ...
          <div className="p-4 rounded-2xl border border-purple-300/20 bg-purple-950/40 backdrop-blur-md">
            <ShieldCheck className="w-5 h-5 text-purple-200 mb-2" />
            <h3 className="text-xs font-semibold text-white mb-1">Maximum Security</h3>
            <p className="text-[11px] text-purple-200/70 leading-relaxed">
        ...
        <div className="prose prose-invert max-w-none space-y-8 text-purple-100/80 text-sm leading-relaxed border-t border-purple-900/30 pt-8">
          <section>
            <h2 className="text-lg font-medium text-white mb-2">1. Client-Side Processing Disclosure</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-medium text-white mb-2">2. Performance & Device Capabilities</h2>
            <p>
              Because all conversions are executed by your device's browser hardware:
            </p>
            <ul className="list-disc pl-5 space-y-1 mt-2 text-purple-200/70">
          ...
          <section>
            <h2 className="text-lg font-medium text-white mb-2">3. Accuracy & Backup Recommendation</h2>
            <p>
